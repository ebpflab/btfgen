...
BTFHUB_REPO="https://github.com/ebpflab/btfhub.git"
BTFHUB_ARCH_REPO="https://github.com/ebpflab/btfhub-archive.git"
...
./tools/btfgen.sh -a ${ARCH} -o ${TARGET_BPF_CORE}

# move tailored BTFs to dist

[ ! -d ${BASEDIR}/btfgen/btfhub ] && mkdir ${BASEDIR}/btfgen/btfhub

rm -rf ${BASEDIR}/btfgen/btfhub/* || true
mv ./custom-archive/* ${BASEDIR}/btfgen/btfhub
